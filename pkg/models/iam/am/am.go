...
import (
	...
	resourcev1alpha3 "devops.kubesphere.io/plugin/pkg/models/resources/v1alpha3"
	"devops.kubesphere.io/plugin/pkg/models/resources/v1alpha3/clusterrole"
	"devops.kubesphere.io/plugin/pkg/models/resources/v1alpha3/clusterrolebinding"
	...
	"devops.kubesphere.io/plugin/pkg/models/resources/v1alpha3/role"
	"devops.kubesphere.io/plugin/pkg/models/resources/v1alpha3/rolebinding"
...
func NewOperator(ksClient kubesphere.Interface, k8sClient kubernetes.Interface,
	factory informers.InformerFactory) AccessManagementInterface {
